...
public class Trajectories extends Module {
  ...
  private void drawTrajectories(EntityPlayer player, float partialTicks) {
    ...
    motionY /= distance;
    motionZ /= distance;
    float f = (item instanceof net.minecraft.item.ItemBow) ? (power * 2.0F) : ((item instanceof net.minecraft.item.ItemFishingRod) ? 1.25F : (pow = (player.getHeldItem(EnumHand.MAIN_HAND).getItem() == Items.EXPERIENCE_BOTTLE) ? 0.9F : 1.0F));
