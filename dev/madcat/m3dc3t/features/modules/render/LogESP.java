...
public class LogESP extends Module {
  ...
  private final Setting<Integer> rainbowhue = register(new Setting("Brightness", Integer.valueOf(255), Integer.valueOf(0), Integer.valueOf(255), v -> ((Boolean)this.rainbow.getValue()).booleanValue()));
  ...
  private final Setting<Boolean> smartScale = register(new Setting("SmartScale", Boolean.FALSE, v -> ((Boolean)this.scaleing.getValue()).booleanValue()));
  ...
  public void onConnection(ConnectionEvent event) {
    if (event.getStage() == 0) {
      ...
      if (entity != null && ((Boolean)this.message.getValue()).booleanValue())
        Command.sendMessage("§a" + entity.getName() + " just logged in" + (((Boolean)this.coords.getValue()).booleanValue() ? (" at (" + entity.posX + ", " + entity.posY + ", " + entity.posZ + ")!") : "!")); 
      ...
      if (((Boolean)this.message.getValue()).booleanValue())
        Command.sendMessage("§c" + event.getName() + " just logged out" + (((Boolean)this.coords.getValue()).booleanValue() ? (" at (" + entity.posX + ", " + entity.posY + ", " + entity.posZ + ")!") : "!")); 
  ...
  private void renderNameTag(String name, double x, double yi, double z, float delta, double xPos, double yPos, double zPos) {
    ...
    this.renderer.drawString2(displayTag, -width, -(this.renderer.getFontHeight() - 1), ColorUtil.toRGBA(new Color(((Integer)this.red.getValue()).intValue(), ((Integer)this.green.getValue()).intValue(), ((Integer)this.blue.getValue()).intValue(), ((Integer)this.alpha.getValue()).intValue())));
