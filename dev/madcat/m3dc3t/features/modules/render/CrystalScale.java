...
public class CrystalScale extends Module {
  ...
  public Setting<Boolean> chams = register(new Setting("Chams", Boolean.valueOf(true)));
  ...
  public Setting<Boolean> xqz = register(new Setting("XQZ", Boolean.FALSE, v -> (!((Boolean)this.rainbow.getValue()).booleanValue() && ((Boolean)this.throughWalls.getValue()).booleanValue())));
  ...
  public Setting<Integer> red = register(new Setting("Red", Integer.valueOf(130), Integer.valueOf(0), Integer.valueOf(255), v -> !((Boolean)this.rainbow.getValue()).booleanValue()));
  
  public Setting<Integer> green = register(new Setting("Green", Integer.valueOf(55), Integer.valueOf(0), Integer.valueOf(255), v -> !((Boolean)this.rainbow.getValue()).booleanValue()));
  
  public Setting<Integer> blue = register(new Setting("Blue", Integer.valueOf(210), Integer.valueOf(0), Integer.valueOf(255), v -> !((Boolean)this.rainbow.getValue()).booleanValue()));
  
  public Setting<Integer> alpha = register(new Setting("Alpha", Integer.valueOf(105), Integer.valueOf(0), Integer.valueOf(255)));
  ...
  public void onRenderModel(RenderEntityModelEvent event) {
    if (event.getStage() != 0 || !(event.entity instanceof EntityEnderCrystal) || !((Boolean)this.wireframe.getValue()).booleanValue())
      return; 
    Color color = ((Boolean)this.rainbow.getValue()).booleanValue() ? ColorUtil.rainbow(((Integer)this.saturation.getValue()).intValue()) : EntityUtil.getColor(event.entity, ((Integer)this.red.getValue()).intValue(), ((Integer)this.green.getValue()).intValue(), ((Integer)this.blue.getValue()).intValue(), ((Integer)this.alpha.getValue()).intValue(), false);
