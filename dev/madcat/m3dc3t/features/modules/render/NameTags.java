...
public class NameTags extends Module {
  ...
  private final Setting<Boolean> max = register(new Setting("Max", Boolean.valueOf(false)));
  ...
  private final Setting<Float> size = register(new Setting("Size", Float.valueOf(2.5F), Float.valueOf(0.1F), Float.valueOf(15.0F)));
  
  private final Setting<Boolean> scaleing = register(new Setting("Scale", Boolean.valueOf(true)));
  
  private final Setting<Boolean> smartScale = register(new Setting("SmartScale", Boolean.valueOf(true), v -> ((Boolean)this.scaleing.getValue()).booleanValue()));
  ...
  private final Setting<Boolean> FCRainbow = register(new Setting("Friend-Rainbow", Boolean.valueOf(true), v -> ((Boolean)this.friendcolor.getValue()).booleanValue()));
  ...
  private final Setting<Boolean> sneak = register(new Setting("Sneak", Boolean.valueOf(true)));
  
  private final Setting<Boolean> SCRainbow = register(new Setting("Sneak-Rainbow", Boolean.valueOf(false), v -> ((Boolean)this.sneak.getValue()).booleanValue()));
  
  private final Setting<Integer> SCred = register(new Setting("Sneak-Red", Integer.valueOf(245), Integer.valueOf(0), Integer.valueOf(255), v -> ((Boolean)this.sneak.getValue()).booleanValue()));
  
  private final Setting<Integer> SCgreen = register(new Setting("Sneak-Green", Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(255), v -> ((Boolean)this.sneak.getValue()).booleanValue()));
  
  private final Setting<Integer> SCblue = register(new Setting("Sneak-Blue", Integer.valueOf(122), Integer.valueOf(0), Integer.valueOf(255), v -> ((Boolean)this.sneak.getValue()).booleanValue()));
  
  private final Setting<Boolean> SORainbow = register(new Setting("SneakOutline-Rainbow", Boolean.valueOf(false), v -> (((Boolean)this.outline.getValue()).booleanValue() && ((Boolean)this.sneak.getValue()).booleanValue())));
  
  private final Setting<Integer> SOred = register(new Setting("SneakOutline-Red", Integer.valueOf(245), Integer.valueOf(0), Integer.valueOf(255), v -> (((Boolean)this.outline.getValue()).booleanValue() && ((Boolean)this.sneak.getValue()).booleanValue())));
  
  private final Setting<Integer> SOgreen = register(new Setting("SneakOutline-Green", Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(255), v -> (((Boolean)this.outline.getValue()).booleanValue() && ((Boolean)this.sneak.getValue()).booleanValue())));
  
  private final Setting<Integer> SOblue = register(new Setting("SneakOutline-Blue", Integer.valueOf(122), Integer.valueOf(0), Integer.valueOf(255), v -> (((Boolean)this.outline.getValue()).booleanValue() && ((Boolean)this.sneak.getValue()).booleanValue())));
  ...
  private void renderNameTag(EntityPlayer player, double x, double y, double z, float delta) {
    ...
    if (((Boolean)this.heldStackName.getValue()).booleanValue() && !renderMainHand.isEmpty && renderMainHand.getItem() != Items.AIR) {
      ...
      this.renderer.drawString2(stackName, -stackNameWidth, -(getBiggestArmorTag(player) + 20.0F), -1);
    ...
    this.renderer.drawString2(displayTag, -width, -(this.renderer.getFontHeight() - 1), getDisplayColor(player));
  ...
  private void renderEnchantmentText(ItemStack stack, int x, int y) {
    ...
    NBTTagList enchants;
    if ((enchants = stack.getEnchantmentTagList()).tagCount() > 2 && ((Boolean)this.max.getValue()).booleanValue()) {
      if (((Boolean)this.maxText.getValue()).booleanValue()) {
        this.renderer.drawString2("", (x * 2), enchantmentY, ColorHolder.toHex(((Integer)this.Mred.getValue()).intValue(), ((Integer)this.Mgreen.getValue()).intValue(), ((Integer)this.Mblue.getValue()).intValue()));
        enchantmentY -= 8;
      } else {
        this.renderer.drawString2("max", (x * 2), enchantmentY, ColorHolder.toHex(((Integer)this.Mred.getValue()).intValue(), ((Integer)this.Mgreen.getValue()).intValue(), ((Integer)this.Mblue.getValue()).intValue()));
        enchantmentY -= 8;
      } 
    } else {
