...
public class Replenish extends Module {
  ...
  private final Setting<Integer> gapStack = register(new Setting("GapStack", Integer.valueOf(50), Integer.valueOf(50), Integer.valueOf(64)));
  
  private final Setting<Integer> xpStackAt = register(new Setting("XPStack", Integer.valueOf(50), Integer.valueOf(50), Integer.valueOf(64)));
