...
public class RenderItemEvent extends EventStage {
  ...
  public RenderItemEvent(double mainX, double mainY, double mainZ, double offX, double offY, double offZ) {
    this.mainX = mainX;
    this.mainY = mainY;
    this.mainZ = mainZ;
    this.offX = offX;
    this.offY = offY;
    this.offZ = offZ;
    this.mainRAngel = this.mainRAngel;
    this.mainRx = this.mainRx;
    this.mainRy = this.mainRy;
    this.mainRz = this.mainRz;
    this.offRAngel = this.offRAngel;
    this.offRx = this.offRx;
    this.offRy = this.offRy;
    this.offRz = this.offRz;
    this.mainHandScaleX = this.mainHandScaleX;
    this.mainHandScaleY = this.mainHandScaleY;
    this.mainHandScaleZ = this.mainHandScaleZ;
    this.offHandScaleX = this.offHandScaleX;
    this.offHandScaleY = this.offHandScaleY;
    this.offHandScaleZ = this.offHandScaleZ;
  }
