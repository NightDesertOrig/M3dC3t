...
public class BlockUtil implements Util {
  public static boolean canBlockBeSeen(double x, double y, double z) {
    if (mc.world.rayTraceBlocks(new Vec3d(mc.player.posX, mc.player.posY + mc.player.getEyeHeight(), mc.player.posZ), new Vec3d(x, y + 1.7D, z), false, true, false) != null)
      return false; 
    return true;
  }
  ...
  public static double getDistance32k(Entity player, BlockPos pos) {
    ...
    double d1 = player.posY + 1.0D - pos.getY();
