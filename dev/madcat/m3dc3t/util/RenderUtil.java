...
public class RenderUtil implements Util {
  ...
  public static void drawSexyBoxM3dC3tIsRetardedFuckYouESP(AxisAlignedBB a, Color boxColor, Color outlineColor, float lineWidth, boolean outline, boolean box, float alpha, float scale, float slab) {
