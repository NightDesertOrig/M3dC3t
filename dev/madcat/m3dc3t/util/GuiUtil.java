...
public class GuiUtil {
  ...
  public static int getHeight() {
    return (ModuleManager.getModuleByName("CustomFont").isEnabled() && ((Boolean)(FontMod.getInstance()).clientFont.getValue()).booleanValue()) ? M3dC3t.fontRenderer.getHeight() : M3dC3t.fontRenderer.getHeight();
  }
