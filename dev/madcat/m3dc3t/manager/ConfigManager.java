...
public class ConfigManager implements Util {
  ...
  public void loadConfig(String name) {
    List<File> files = (List<File>)Arrays.<Object>stream((Object[])Objects.requireNonNull((new File("M3dC3t")).listFiles())).filter(File::isDirectory).collect(Collectors.toList());
