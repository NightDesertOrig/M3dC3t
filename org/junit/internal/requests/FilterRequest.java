...
public final class FilterRequest extends Request {
  ...
  public Runner getRunner() {
    try {
      ...
      return (Runner)new ErrorReportingRunner(Filter.class, new Exception(String.format("No tests found matching %s from %s", new Object[] { this.fFilter.describe(), this.fRequest.toString() })));
    } 
  }
}
